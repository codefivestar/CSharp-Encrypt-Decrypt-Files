...
namespace CSharp_Encrypt_Decrypt_Files
{
    class AES256
    {
        public static void Encrypt()
        {
            ...
            // Encrypt the file
            FileEncrypt(@"C:\Hidequel-Puga\TST\Config.json", password);
        ...
        public static void Decrypt()
        {
            ...
            // Decrypt the file
            FileDecrypt(@"C:\Hidequel-Puga\TST\Config.json.aes", @"C:\Hidequel-Puga\TST\Config.json", password);
